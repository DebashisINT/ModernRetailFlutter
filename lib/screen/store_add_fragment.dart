...
class _StoreAddFragmentState extends State<StoreAddFragment> {
  ...
  Widget buildInputField(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColor.colorWhite, // White background for the input field
      ...
      child: Row(
        children: [
          // Grey rectangle with the icon
          Container(
            width: 50, // Width of the grey rectangle
            height: 55, // Match the height of the input field
            decoration: BoxDecoration(
          ...
          /*Expanded(
            child: isDropdown
                ? DropdownButton<StoreTypeEntity>(
              isExpanded: true,
              underline: SizedBox(),
              value: selectedStoreType.type_name.isEmpty
                  ? null
                  : selectedStoreType, // Default value
              hint: Text(
                selectedStoreType.type_name.isEmpty
                    ? "Select Store Type"
                    : selectedStoreType.type_name,
